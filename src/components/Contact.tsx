          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-semibold text-dark-700 dark:text-dark-300">Email</h4>
                  <p className="text-dark-600 dark:text-dark-400">eureliandev@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-semibold text-dark-700 dark:text-dark-300">Location</h4>
                  <p className="text-dark-600 dark:text-dark-400">Basel, Switzerland</p>
                </div>
              </div>
            </div>

            <div className="mt-8">
              <h4 className="font-semibold text-dark-700 dark:text-dark-300 mb-4">Follow Me</h4>
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-primary-100 dark:bg-primary-900/20 rounded-lg flex items-center justify-center text-primary-600 dark:text-primary-400 hover:bg-primary-200 dark:hover:bg-primary-900/40 transition-colors"
                >
